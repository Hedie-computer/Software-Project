...
This project followed a strict professional Git workflow using branches for feature development.
- **Merge Commit:** All features were integrated into the `main` branch via Pull Requests.

**Key Commit History:**
1. **Initial Commit:** `f0c959f`
2. **Initial Project Setup:** `db83511`
3. **Merge Pull Request (Feature Integration):** `bfa39f6`
